...
if __name__ == '__main__':
    ...
    print("Expected: '[PyController] Received event:' and '[PyController] Doing state change'")
    airco2.temperature(20.5)
    airco2.temperature(21.2)
    airco2.temperature(20.6)
    airco2.temperature(19.9)
    airco2.temperature(20.4)
    airco2.stop()
